...
function ProjectCard({ project }) {
  return (
    <Link to={`/projects/${project.id}`} className="group block">
      <div className="img-zoom rounded-sm overflow-hidden mb-4 aspect-[4/3]">
        <img src={project.image} alt={project.title} className="w-full h-full object-cover" />
      </div>
      <div className="flex justify-between items-start">
        <div>
          <p className="text-[11px] tracking-[0.2em] uppercase text-yellow-600 mb-1">{project.category}</p>
          <h3 className="section-title text-[1.3rem]">{project.title}</h3>
        </div>
        <div className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center group-hover:bg-gray-900 group-hover:border-gray-900 transition-all">
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="section-title mb-6 gold-line-left">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 shadow-xl">
                <div className="text-3xl font-light text-yellow-600 mb-1" style={{fontFamily:"'Cormorant Garamond',serif"}}>18+</div>
                <div className="text-xs tracking-widest uppercase text-gray-500">Years of Excellence</div>
              </div>
              <div className="absolute -top-6 -right-6 bg-[#1a1a1a] p-6 text-white">
                <div className="text-3xl font-light text-yellow-400 mb-1" style={{fontFamily:"'Cormorant Garamond',serif"}}>200+</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            <div>
              ...
              <h2 className="section-title gold-line-left">Featured Projects</h2>
            </div>
            <Link to="/projects" className="btn-outline mt-6 md:mt-0">View All Projects</Link>
          </div>
      ...
      <section ref={servRef} className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="section-title gold-line">Our Services</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((s, i) => (
              <div key={s.id} className={`card-hover bg-white border border-gray-100 rounded-sm overflow-hidden group ${servInView ? "animate-fade-up" : "opacity-0"}`}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-yellow-600 text-sm font-medium">{s.price}</span>
                    <Link to="/services" className="text-[12px] tracking-widest uppercase text-gray-400 hover:text-gray-900 transition-colors flex items-center gap-1 group">
      ...
      <section className="py-24 bg-[#1a1a1a] text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-[11px] tracking-[0.25em] uppercase mb-4" style={{color:"#c49a4e"}}>Why Sharma Interior</p>
            <h2 className="section-title text-white gold-line">The Sharma Difference</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="border border-white/10 p-8 hover:border-yellow-600 transition-colors group">
                <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center mb-6 group-hover:bg-yellow-600 transition-colors">
                  <Icon size={22} className="text-yellow-600 group-hover:text-white transition-colors" />
                </div>
                <h3 className="text-lg font-medium mb-3" style={{fontFamily:"'Cormorant Garamond',serif"}}>{title}</h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="section-title gold-line">Our Simple Process</h2>
          </div>
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              <div key={step} className="text-center relative z-10">
                <div className="w-20 h-20 rounded-full bg-cream-100 border-2 border-yellow-200 flex items-center justify-center mx-auto mb-6" style={{background:"#fdf9ec", borderColor:"#d4af6e"}}>
                  <span className="text-2xl font-light text-yellow-600" style={{fontFamily:"'Cormorant Garamond',serif"}}>{step}</span>
                </div>
                <h3 className="text-lg font-medium mb-2" style={{fontFamily:"'Cormorant Garamond',serif"}}>{label}</h3>
      ...
      <section className="py-24 bg-sage-50" style={{background:"#eef1ec"}}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="section-title mb-16 gold-line">What Our Clients Say</h2>
          <div className="relative">
            <div className="bg-white rounded-sm p-12 shadow-sm">
              <div className="flex justify-center mb-4">
                {[...Array(testimonials[testimIdx].rating)].map((_, i) => (
                  <Star key={i} size={16} className="fill-yellow-500 text-yellow-500 mx-0.5" />
                ))}
              </div>
            ...
            <div className="flex justify-center gap-3 mt-8">
              <button onClick={prev} className="w-10 h-10 border border-gray-300 flex items-center justify-center hover:border-yellow-600 hover:text-yellow-600 transition-all">
                <ChevronLeft size={18} />
              </button>
              <div className="flex gap-2 items-center">
                {testimonials.map((_, i) => (
                  <button key={i} onClick={() => setTestimIdx(i)}
                    className={`h-1.5 rounded-full transition-all ${i === testimIdx ? "w-8 bg-yellow-600" : "w-1.5 bg-gray-300"}`} />
                ))}
              </div>
              <button onClick={next} className="w-10 h-10 border border-gray-300 flex items-center justify-center hover:border-yellow-600 hover:text-yellow-600 transition-all">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center text-white">
          <p className="text-[11px] tracking-[0.3em] uppercase mb-6" style={{color:"#d4af6e"}}>Start Your Journey</p>
          <h2 className="section-title-lg text-white mb-6">
            Ready to Transform<br />
            <span className="italic font-light" style={{color:"#d4af6e"}}>Your Space?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/919876543210" target="_blank" rel="noreferrer"
              className="btn-outline btn-outline-white flex items-center justify-center gap-2">
